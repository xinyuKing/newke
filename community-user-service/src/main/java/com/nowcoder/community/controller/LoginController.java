...
public class LoginController implements CommunityConstant {
    ...
    public String login(Model model, String username,String password,String code,boolean rememberme,/*HttpSession session,*/HttpServletResponse response,@CookieValue(value = "kaptchaOwner", required = false)String kaptchaOwner){
    ...
    public String register(Model model, User user){
        ...
        if(msg==null||msg.isEmpty()){
            model.addAttribute("msg","注册成功，我们已向您的邮箱发送激活邮件，请查看您的邮箱！");
    ...
    public String activation(Model model, @PathVariable("userId") int userId,@PathVariable("code") String code){
        ...
        if(result==ACTIVATION_SUCCESS){
            ...
            model.addAttribute("msg","无效操作，该用户已激活！");
            model.addAttribute("target","/index");
        }else {
