...
public class PostScoreRefreshJob implements Job, CommunityConstant {
    ...
    static {
        try {
            epoch=new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2014-08-01 00:00:00");
        } catch (ParseException e) {
            throw new RuntimeException("初始化建立纪元失败！",e);
        }
    }
    ...
    private void refresh(int postId){
        ...
        long entityLikeCount = likeCountValue == null ? 0L : likeCountValue;
