...
public class RefundIntentSample {
    ...
    public static List<RefundIntentSample> defaultSamples() {
        ...
        samples.add(new RefundIntentSample("\u9000\u8d27\u9000\u6b3e\uff0c\u5546\u54c1\u7834\u635f", RefundIntentLabel.REFUND));
        samples.add(new RefundIntentSample("refund for broken item", RefundIntentLabel.REFUND));
        samples.add(new RefundIntentSample("\u672a\u6536\u5230\u8d27\uff0c\u8bf7\u9000\u6b3e", RefundIntentLabel.REFUND));
        samples.add(new RefundIntentSample("\u53ea\u60f3\u9000\u6b3e\uff0c\u4e0d\u8981\u5546\u54c1", RefundIntentLabel.REFUND));
