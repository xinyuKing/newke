...
public interface CommentMapper {
    ...
    List<Comment> selectCommentsByEntityIds(@Param("entityType") int entityType, @Param("entityIds") List<Integer> entityIds);

    //閫氳繃entityType鍜宨d鍒楄〃缁熻鏁伴噺
    List<EntityCount> selectCountByEntityIds(@Param("entityType") int entityType, @Param("entityIds") List<Integer> entityIds);
}
